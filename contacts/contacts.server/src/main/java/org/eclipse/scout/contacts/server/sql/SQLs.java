...
public interface SQLs {
	...
	String ORGANIZATION_VALUES_01 = "" + "VALUES  ('org01', " + "         'Eclipse Foundation', "
			+ "         'Brussels', " + "         'BE', " + "         'https://www.eclipse.org/org/foundation/', "
	...
	String ORGANIZATION_VALUES_02 = "" + "VALUES  ('org02', " + "         'BSI Business Systems Integration AG', "
			+ "         'Baden', " + "         'CH', " + "         'https://www.bsi-software.com', "
	...
	String PERSON_VALUES_01 = "" + "VALUES   ('prs01', " + "          'Kenneth', " + "          'Hartley', "
			+ "          'avatars/Kenneth.jpg', " + "          '06.03.1977', " + "          'M', "
			+ "          '2203 Edington Drive', " + "          'Smyrna', " + "          'US', "
			+ "          'Webmaster', " + "          'org01')";

	String PERSON_VALUES_02 = "" + "VALUES   ('prs02', " + "          'Thea', " + "          'Ommundsen', "
			+ "          'avatars/Thea.jpg', " + "          '17.12.1999', " + "          'F', "
			+ "          'Nermarka 246', " + "          'Trondheim', " + "          'NO', "
			+ "          'Airport terminal controller', " + "          'org01')";

	String PERSON_VALUES_03 = "" + "VALUES   ('prs03', " + "          'Julek', " + "          'Ostrowski', "
			+ "          'avatars/Julek.jpg', " + "          '05.11.1954', " + "          'M', "
			+ "          'ul. Kiepury Jana 56', " + "          'Kielce', " + "          'PL', "
			+ "          'Food processing occupation', " + "          'org02')";

	String PERSON_VALUES_04 = "" + "VALUES   ('prs04', " + "          'Joséphine', " + "          'Doiron', "
			+ "          'avatars/Josephine.jpg', " + "          '18.08.1990', " + "          'F', "
			+ "          '80, Rue Hubert de Lisle', " + "          'Lion', " + "          'FR', "
			+ "          'Optometrist', " + "          'org02')";

	String PERSON_VALUES_05 = "" + "VALUES   ('prs05', " + "          'Bagi', " + "          'Gergely', "
			+ "          'avatars/Bagi.jpg', " + "          '21.03.1972', " + "          'M', "
			+ "          'Tas vezér u. 5.', " + "          'Kistormás', " + "          'HU', "
			+ "          'Law librarian', " + "          'org02')";

	String PERSON_VALUES_06 = "" + "VALUES   ('prs06', " + "          'Federica', " + "          'Serrato', "
			+ "          'avatars/Federica.jpg', " + "          '17.12.1982', " + "          'F', "
			+ "          'Boriñaur enparantza, 9', " + "          'Robregordo', " + "          'ES', "
			+ "          'Customer services manager', " + "          'org02')";

	String PERSON_VALUES_07 = "" + "VALUES   ('prs07', " + "          'Basimah', " + "          'Rahal', "
			+ "          'avatars/Basimah.jpg', " + "          '07.05.1969', " + "          'F', "
			+ "          '120 Avenue Aghlabité', " + "          'Cide el Khrachfa', " + "          'TN', "
			+ "          'Personnel officer', " + "          'org02')";

	String PERSON_VALUES_08 = "" + "VALUES   ('prs08', " + "          'Bethany', " + "          'Pasco', "
			+ "          'avatars/Bethany.jpg', " + "          '08.10.1991', " + "          'F', "
			+ "          '2 Albert Street', " + "          'Innisplain ', " + "          'AU', "
			+ "          'Benefits administrator', " + "          'org02')";

	String PERSON_VALUES_09 = "" + "VALUES   ('prs09', " + "          'Livia', " + "          'Barros', "
			+ "          'avatars/Livia.jpg', " + "          '25.12.1978', " + "          'F', "
			+ "          'Rua dos Cinamomos, 356', " + "          'Caxias do Sul', " + "          'BR', "
			+ "          'General trial court judge', " + "          'org02')";

	String PERSON_VALUES_10 = "" + "VALUES   ('prs10', " + "          'Mulan', " + "          'Chien', "
			+ "          'avatars/Mulan.jpg', " + "          '15.04.1987', " + "          'F', "
			+ "          'Lungolago 11', " + "          'Tartegnin', " + "          'CH', " + "          'Promoter', "
			+ "          'org02')";

	String PERSON_VALUES_11 = "" + "VALUES   ('prs11', " + "          'Gustav', " + "          'Østergaard', "
			+ "          'avatars/Gustav.jpg', " + "          '05.02.1961', " + "          'M', "
			+ "          'Stenløsegyden 9', " + "          'København', " + "          'DK', "
			+ "          'Training consultant', " + "          'org02')";

	String PERSON_VALUES_12 = "" + "VALUES   ('prs12', " + "          'Malik', " + "          'Lundblad', "
			+ "          'avatars/Malik.jpg', " + "          '05.12.1965', " + "          'M', "
			+ "          'Ringvej 235', " + "          'Qaqortoq', " + "          'GL', "
			+ "          'Executive administrator', " + "          'org02')";

	String PERSON_VALUES_13 = "" + "VALUES   ('prs13', " + "          'Gandolfo', " + "          'Cattaneo', "
			+ "          'avatars/Gandolfo.jpg', " + "          '03.12.1976', " + "          'M', "
			+ "          'Via delle Mura Gianicolensi, 45', " + "          'Ripabottoni Stazione', "
			+ "          'IT', " + "          'Linguistic anthropologist', " + "          'org02')";

	String PERSON_VALUES_14 = "" + "VALUES   ('prs14', " + "          'Maurizia', " + "          'Piccio', "
			+ "          'avatars/Maurizia.jpg', " + "          '24.07.1971', " + "          'F', "
			+ "          'Via Campi Flegrei, 106', " + "          'Villanova Del Battista', " + "          'IT', "
			+ "          'Home health aide', " + "          'org02')";

	String PERSON_VALUES_15 = "" + "VALUES   ('prs15', " + "          'Hashim', " + "          'van Wel', "
			+ "          'avatars/Hashim.jpg', " + "          '03.09.1969', " + "          'M', "
			+ "          'Rosier Faassenstraat 131', " + "          'Rotterdam', " + "          'NL', "
			+ "          'Parking enforcement worker', " + "          'org02')";

	String PERSON_VALUES_16 = "" + "VALUES   ('prs16', " + "          'Atifa', " + "          'Sulejmanoski', "
			+ "          'avatars/Atifa.jpg', " + "          '18.01.1993', " + "          'F', "
			+ "          'Tavcarjeva 5', " + "          'Škocjan', " + "          'SL', "
			+ "          'Group exercise instructor', " + "          'org02')";

	String PERSON_VALUES_17 = "" + "VALUES   ('prs17', " + "          'Verónica', " + "          'Ulibarri', "
			+ "          'avatars/Veronica.jpg', " + "          '25.12.2002', " + "          'F', "
			+ "          'Avda. Los llanos, 58', " + "          'Villalba de Rioja', " + "          'ES', "
			+ "          'Traffic clerk', " + "          'org02')";

	String PERSON_VALUES_18 = "" + "VALUES   ('prs18', " + "          'Jiřina', " + "          'Třetinová', "
			+ "          'avatars/Jirina.jpg', " + "          '15.09.1988', " + "          'F', "
			+ "          'Nerudova 1158', " + "          'Ledenice', " + "          'CZ', "
			+ "          'Clock repairer', " + "          'org02')";

	String PERSON_VALUES_19 = "" + "VALUES   ('prs19', " + "          'Ghassan', " + "          'Halabi', "
			+ "          'avatars/Ghassan.jpg', " + "          '15.05.1974', " + "          'M', "
			+ "          '1 Rue Tahar Khmiri', " + "          'Baajla', " + "          'TN', "
			+ "          'Geotechnical engineer', " + "          'org02')";

	String PERSON_VALUES_20 = "" + "VALUES   ('prs20', " + "          'Gemma', " + "          'Faucher', "
			+ "          'avatars/Gemma.jpg', " + "          '03.06.1979', " + "          'F', "
			+ "          '2215 Wolmarans St', " + "          'Witbank', " + "          'ZA', "
			+ "          'Personal appearance worker', " + "          'org02')";
